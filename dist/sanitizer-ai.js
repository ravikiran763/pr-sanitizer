...
exports.getCommentedLineContent = getCommentedLineContent;
const rest_1 = require("@octokit/rest");
const generative_ai_1 = require("@google/generative-ai");
// Ask Gemini AI if the comment should be rewritten and how
async function analyzeAndRewriteCommentGemini(genAI, comment, lineContents) {
    const prompt = `
...
async function getCommentedLineContent(octokit, owner, repo, comment) {
